...
function MobileHeaderSkeleton() {
  return (
    <div className="mb-5 text-center sm:mb-6 lg:hidden">
      ...
      <Skeleton className="mx-auto mt-3 h-8 w-64 sm:mt-4 sm:h-9" />
      <Skeleton className="mx-auto mt-2 h-4 w-56 max-w-sm" />
    </div>
  );
}

function MobilePerksSkeleton() {
  return (
...
export default function LoginLoading() {
  return (
    <div className="w-full overflow-x-hidden" aria-busy="true" aria-label="Loading sign in">
