...
function StepCardSkeleton() {
  return (
    <div className="flex gap-3 rounded-xl border border-slate-800 bg-slate-900/50 p-3 sm:gap-4 sm:p-4">
      <Skeleton className="h-7 w-8 shrink-0 sm:h-8" />
...
function MobileHeaderSkeleton() {
  return (
    <div className="mb-5 text-center sm:mb-6 lg:hidden">
      ...
      <Skeleton className="mx-auto mt-3 h-8 w-72 sm:mt-4 sm:h-9" />
      <Skeleton className="mx-auto mt-2 h-4 w-64 max-w-sm" />
    </div>
  );
}

function MobileStepsSkeleton() {
  return (
    <div className="mt-6 space-y-4 sm:mt-8 lg:hidden">
      ...
      <div className="flex flex-col gap-2 min-[480px]:flex-row">
        <Skeleton className="h-10 w-full rounded-lg min-[480px]:flex-1" />
        <Skeleton className="h-10 w-full rounded-lg min-[480px]:flex-1" />
      </div>
    </div>
  );
...
export default function RegisterLoading() {
  return (
    <div className="w-full overflow-x-hidden" aria-busy="true" aria-label="Loading registration">
