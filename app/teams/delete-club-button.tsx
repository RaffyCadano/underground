          ...
          <div className="card relative z-10 w-full max-w-md p-6 shadow-xl" onClick={(e) => e.stopPropagation()}>
            <div className="flex items-start justify-between gap-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h2 id="delete-club-title" className="text-lg font-semibold text-white">
                    Delete community club?
                  </h2>
                  <p className="mt-2 text-sm text-slate-400">
                    <span className="font-medium text-slate-200">{clubName}</span> will be removed from the public
                    teams directory.
                  </p>
                </div>
              </div>
