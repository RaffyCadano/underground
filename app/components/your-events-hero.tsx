...
export function YourEventsHero({ createHref }: Props) {
  return (
    <div className="relative overflow-hidden rounded-2xl border border-slate-800 bg-gradient-to-br from-brand-500/12 via-slate-950 to-slate-950 px-6 py-8 sm:px-10 sm:py-10">
      ...
      <div className="relative max-w-2xl">
        ...
        <p className="mt-3 text-lg font-medium italic text-brand-300 sm:text-xl">
          Start building your event!
        </p>
        <p className="mt-4 text-sm leading-relaxed text-slate-400 sm:text-base">
          Create multiple tournaments, sell tickets, manage attendees, and more.
        </p>
        <Link href={createHref} className="btn-primary mt-6 inline-flex items-center gap-2">
          <Plus size={16} />
          Create an Event
        </Link>
      </div>
